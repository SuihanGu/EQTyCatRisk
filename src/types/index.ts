...
export interface CouplingEvent {
  ...
  typhoonWinds?: number[]
  sourceIndex?: number
  /** Optional study-area boundary used by the risk map. */
...
/** Risk-page grid loss point (validated without_Other result). */
...
export interface RiskCaseEvent extends CouplingEvent {
  ...
  /** Study-area outer boundary derived from grid polygons. */
  boundary?: Array<Array<[number, number]>>
  gridHalfDeg?: number
  /** 分文件加载网格 */
  gridCellsUrl?: string
